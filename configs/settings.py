...
def get_omniguard_path() -> Path:
    ...
    if env_path:
        return env_path
    possible_paths = [
        # Linux — external/ 하위 (정리된 구조)
        BASE_DIR / "external" / "OmniGuard-main",
        # Linux (구 위치 호환)
    ...
    for path in possible_paths:
        try:
            ...
            continue
    return BASE_DIR / "external" / "OmniGuard-main"
...
def get_catnet_path() -> Path:
    ...
    if env_path:
        return env_path
    possible_paths = [
        BASE_DIR / "external" / "CAT-Net-main",
    ...
    for path in possible_paths:
        try:
            ...
            continue
    return BASE_DIR / "external" / "CAT-Net-main"
...
def get_mesorch_path() -> Path:
    ...
    if env_path:
        return env_path
    possible_paths = [
        BASE_DIR / "external" / "Mesorch-main",
    ...
    for path in possible_paths:
        try:
            ...
            continue
    return BASE_DIR / "external" / "Mesorch-main"
